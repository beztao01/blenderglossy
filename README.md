# Blender Principled
Una librería visual donde el valor a modificar es el roughness y el valor del metalic en 1
...
En la imagen de arriba se muestra la previzualización desde el browser.
